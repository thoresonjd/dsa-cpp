 ...
 * @brief Tests for selection sort.
...
using dsa::selectionSort;

TEST(SelectionSort, SortNonDescendingSortedArray) {
...
TEST(SelectionSort, SortNonAscendingSortedArray) {
	int arr[] = {
		9, 9, 8, 8, 7, 7, 6, 6, 5, 5,
		4, 4, 3, 3, 2, 2, 1, 1, 0, 0
	};
...
TEST(SelectionSort, SortUnsortedArray) {
